...
namespace mobu_backend.Migrations
{
    ...
    [Migration("20230715225934_test_pedidos_3")]
    partial class test_pedidos_3
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("mobu_backend.Models.Pedidos_Amizade", b =>
                {
                    ...
                    b.Property<int?>("Utilizador_RegistadoIDUtilizador")
                        .HasColumnType("int");

                    b.HasKey("RemetenteFK");

                    b.HasIndex("Utilizador_RegistadoIDUtilizador");
            ...
            modelBuilder.Entity("mobu_backend.Models.Pedidos_Amizade", b =>
                {
                    ...
                    b.HasOne("mobu_backend.Models.Utilizador_Registado", null)
                        .WithMany("ListaPedidosRecebidos")
                        .HasForeignKey("Utilizador_RegistadoIDUtilizador");

...
namespace mobu_backend.Migrations
{
    ...
    [Migration("20230728113948_fotos_4")]
    partial class fotos_4
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mobu_backend.Models.Fotografia_Admin", b =>
                {
                    b.HasOne("mobu_backend.Models.Admin", "Admin")
                        .WithOne("Fotografia")
                        .HasForeignKey("mobu_backend.Models.Fotografia_Admin", "AdminFK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("mobu_backend.Models.Fotografia_Anonimo", b =>
                {
                    b.HasOne("mobu_backend.Models.Utilizador_Anonimo", "Anonimo")
                        .WithOne("Fotografia")
                        .HasForeignKey("mobu_backend.Models.Fotografia_Anonimo", "AnonimoFK")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Anonimo");
                });

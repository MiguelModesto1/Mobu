...
namespace mobu_backend.Areas.Identity.Pages.Account.Manage
{
    ...
    public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Compare("NewPassword", ErrorMessage = "A nova palavra-passe e a sua confirmação não coincidem.")]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("Administrador alterou a sua palavara-passe com êxito.");

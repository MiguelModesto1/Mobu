...
namespace mobu_backend.Controllers
{
    public class Destinatario_Pedidos_AmizadeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IDPedido,IDDestinatarioPedido,EstadoPedido,RemetenteFK")] Destinatario_Pedidos_Amizade destinatario_Pedidos_Amizade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IDPedido,IDDestinatarioPedido,EstadoPedido,RemetenteFK")] Destinatario_Pedidos_Amizade destinatario_Pedidos_Amizade)
        {

...
/// </summary>
[ApiController]
public class TestLoginApiController : ControllerBase
{
    ...
    public async Task<IActionResult> GetNewCookie([FromQuery(Name = "id")] int id)
    {
        ...
        Response.Cookies.Delete("Session-Id-" + id);

        expiry = DateTimeOffset.Now.AddMinutes(15);
        Response.Cookies.Append("Session-Id-" + id, sessionId, new CookieOptions { HttpOnly = true, Secure = true, Expires = expiry });
            ...
            if (identityUser != null && user != null)
            {
                ...
                if (confirmPassword)
                {
                    ...
                    var claim = new IdentityUserClaim<string>
                    {
                        ...
                        ClaimType = "Session-Id-" + user.IDUtilizador,
                    ...
                    expiry = DateTimeOffset.Now.AddMinutes(15);
                    Response.Cookies.Append("Session-Id-" + user.IDUtilizador, claimValue, new CookieOptions { HttpOnly = true, Secure = true, Expires = expiry });

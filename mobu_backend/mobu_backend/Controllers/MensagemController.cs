...
namespace mobu_backend.Controllers
{
    public class MensagemController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IDMensagemSala,IDMensagem,ConteudoMsg,EstadoMensagem,RemetenteFK,SalaFK")] Mensagem mensagem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IDMensagemSala,IDMensagem,ConteudoMsg,EstadoMensagem,RemetenteFK,SalaFK")] Mensagem mensagem)
        {
